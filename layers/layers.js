...
jsonSource_ne_10m_airports_0.addFeatures(features_ne_10m_airports_0);var lyr_ne_10m_airports_0 = new ol.layer.Vector({
    ...
    <img src="styles/legend/ne_10m_airports_0_3.png" /> spaceport<br />\
    <img src="styles/legend/ne_10m_airports_0_4.png" /> <br />'
        });

lyr_ne_10m_airports_0.setVisible(true);
var layersList = [baseLayer,lyr_ne_10m_airports_0];
lyr_ne_10m_airports_0.set('fieldAliases', {'scalerank': 'scalerank', 'featurecla': 'featurecla', 'type': 'TIPE', 'name': 'NAMA', 'abbrev': 'abbrev', 'location': 'location', 'gps_code': 'gps_code', 'iata_code': 'IATA CODE', 'wikipedia': 'URL', 'natlscale': 'natlscale', 'Type': 'Type', });
